        ...
        <img src="http://www.amlbd.com/wp-content/uploads/2014/05/new-way-to-manage1.png" style="width :8%;">
			...
			<div id="main-nav" class="collapse navbar-collapse">
				<ul class="navbar-nav ml-auto">
					<li><a href="{{route('Igloo_CHO')}}" class="nav-item nav-link" style="font-size: 80%;">Igloo CHO</a></li>
					<li><a href="{{route('constructions')}}" class="nav-item nav-link" style="font-size: 80%;">Construction CHO</a></li>
					<li><a href="{{route('sugers')}}" class="nav-item nav-link" style="font-size: 80%;">Sugar CHO</a></li>
					<li><a href="{{route('beverages')}}" class="nav-item nav-link" style="font-size: 80%;">Beverage</a></li>
					<li><a href="{{route('hmp')}}" class="nav-item nav-link" style="font-size: 80%;">HR & Admin,Procurement, MIS</a></li>
          <li><a href="{{route('Itcus')}}" class="nav-item nav-link" style="font-size: 80%;">IT CUSTUDY</a></li>
