<div class="card">
	...
	<div class="row mb-3 p-2 d-flex justify-content-between">
		<div>
			@if ($checkedDredging)
			<button class="btn btn-danger btn-md ml-4" wire:click="deleteDredgings()"> Delete rows ({{ count($checkedDredging) }})</button>
			@endif
		</div>
	</div>
		...
		<table class="table table-hover table-bordered" id="Dredgings">
			...
			<tbody>
				...
				<tr class="{{ $this->isChecked($Dredging->id) }}">
                    ...
                    <td>
                        <div class="btn-group container">
                            &nbsp;&nbsp;&nbsp;<a href="#" wire:click="OpenEditModal({{$Dredging->id}})"><img src="https://cdn-icons-png.flaticon.com/512/5278/5278663.png" style="width: 30px;" title="Update Row"></img></a>
                        </div>
                    </td>
                    @elseif(Session::get('admin_type') == "Mod" && Session::get('delete') == "True" && Session::get('return') == null && Session::get('update') == null)
                    <td>
