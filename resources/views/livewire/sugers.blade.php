    <div class="card">
        ...
        <div class="row mb-3 p-2 d-flex justify-content-between">
            <div>
                @if ($checkedSuger)
                <button class="btn btn-danger btn-md ml-4" wire:click="deleteSugers()"> Delete rows ({{ count($checkedSuger) }})</button>
                @endif
            </div>
        </div>
            ...
            <table class="table table-hover table-bordered" id="Sugar">
                ...
                <tbody>
                    ...
                    <tr class="{{ $this->isChecked($Suger->id) }}">
                        ...
                        <td  data-id="{{ $Suger->id }}" data-column="issue_date" style="white-space: nowrap;">{{ $Suger->issue_date }}</td>
                        ...
                        @endif
                        <td  data-id="{{ $Suger->id }}" data-column="vendor" style="white-space: nowrap;">{{ $Suger->vendor }}</td>
                        @if(Session::get('admin_type') == "SAdmin")
                        <td>
