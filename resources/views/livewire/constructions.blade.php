    <div class="card">
        ...
        <div class="row mb-3 p-2 d-flex justify-content-between">
            <div>
                ...
                <button class="btn btn-danger btn-md ml-4" wire:click="deleteConstructions()"> Delete rows ({{ count($checkedConstruction) }})</button>
                @endif
            </div>
        </div>
            ...
            <table class="table table-hover table-bordered" id="Cons">
                ...
                <tbody>
                    ...
                    <tr class="{{ $this->isChecked($Construction->id) }}">
                        ...
                        <td  data-id="{{ $Construction->id }}" data-column="issue_date" style="white-space: nowrap;">{{ $Construction->issue_date }}</td>
                        ...
                        @endif
                        <td  data-id="{{ $Construction->id }}" data-column="vendor" style="white-space: nowrap;">{{ $Construction->vendor }}</td>
                        @if(Session::get('admin_type') == "SAdmin")
                        <td>
