        ...
        <table class="table table-hover table-bordered" id="foods">
            ...
            <tbody>
                ...
                <tr class="{{ $this->isChecked($Food->id) }}">
                    ...
                    <td  data-id="{{ $Food->id }}" data-column="issue_date" style="white-space: nowrap;">{{ $Food->issue_date }}</td>
					...
					@elseif( strtotime($Food->warrenty_end) >= strtotime($date) && $Food->warrenty_end != Null)
					<td  data-id="{{ $Food->id }}" class="text-white bg-primary" data-column="warrenty_end" style="white-space: nowrap;">{{ $Food->warrenty_end }}</td>
					@else
					<td  data-id="{{ $Food->id }}"  data-column="warrenty_end" style="white-space: nowrap;">{{ $Food->warrenty_end }}</td>
					@endif
                    <td  data-id="{{ $Food->id }}" data-column="vendor" style="white-space: nowrap;">{{ $Food->vendor }}</td>
                    @if(Session::get('admin_type') == "SAdmin")
                    <td>
                    ...
                    <td>
                        <div class="btn-group container">
                            &nbsp;&nbsp;&nbsp;<a href="#" wire:click="OpenEditModal({{$Food->id}})"><img src="https://cdn-icons-png.flaticon.com/512/5278/5278663.png" style="width: 30px;" title="Update Row"></img></a>
                        </div>
                    </td>
                    @elseif(Session::get('admin_type') == "Mod" && Session::get('delete') == "True" && Session::get('return') == null && Session::get('update') == null)
                    <td>
