...
<head>
    ...
    <style>
    #Admins tr:nth-child(even){background-color: #b2b2b2;}
    </style>
    @livewireStyles
</head>
<body>
    ...
    <script>
        ...
        window.addEventListener('swal:deleteAdmins', function(event){
            swal.fire({
                title:event.detail.title,
                html:event.detail.html,
                icon: 'warning',
                ...
                if(result.value){
                    window.livewire.emit('deleteCheckedAdmins',event.detail.checkedIDs);
                }
            });
        });
    </script>
